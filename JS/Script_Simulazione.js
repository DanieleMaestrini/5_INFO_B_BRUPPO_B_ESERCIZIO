...
var Dati={
    ...
    NumeroSani: PopolazioneTot-NumeroContagiati,
...
function simulazione(dati) {
    ...
    class Pallino {
        ...
        controlla() {
            ...
            this.urtoParete();
            if (new Date().getTime() - this.tempo > dati.TGUAR && this.tempo > 0) {
                this.stato = 2;
            }
        }
    ...
    for (i = 0; i < pallinicalc.length; i++) {
        var stato = dati.NCONT-- > 0 ? 1 : 0;
        var velocita = dati.NQUAR-- > 0 ? 0 : 2;
